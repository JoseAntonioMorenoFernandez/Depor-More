...
if (isset($_SESSION['activar_administrador'])) {
    $activar_administrador = $_SESSION['activar_administrador'];
    
    $email = $activar_administrador['email'];
    $dni = $activar_administrador['dni'];
    $nombre = $activar_administrador['nombre'];
    $apellidos = $activar_administrador['apellidos'];
    $direccion = $activar_administrador['direccion'];
    $localidad = $activar_administrador['localidad'];
    $cpostal = $activar_administrador['cpostal'];
    $provincia = $activar_administrador['provincia'];
    $telefono = $activar_administrador['telefono'];
    $rol = $activar_administrador['rol'];
    
    unset($_SESSION['activar_administrador']);
}
?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="./usuarios/activar_administrador.php" method="POST">
                        <div class="mb-3">
