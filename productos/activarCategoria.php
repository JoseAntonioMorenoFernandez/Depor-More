...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <h3 class="mb-4 text-center border p-3 bg-primary text-white">Activar Categoría</h3>
            <form action="./productos/activar_categoria.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nom_cat" name="nom_cat" value="<?php echo $nom_cat; ?>" class="form-control" readnoly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nom_sub" name="nom_sub" value="<?php echo $nom_sub; ?>" class="form-control" readonly>
                </div>
