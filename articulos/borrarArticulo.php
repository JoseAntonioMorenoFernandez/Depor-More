    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="bg-light p-3 rounded">
                <form action="./articulos/borrar_articulo.php" method="post" enctype="multipart/form-data">
                    <div class="bg-danger text-white p-2 mb-2 text-center">
                        <h3>Borrar Artículos</h3>
                    </div>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-danger">Borrar Artículo</button>
