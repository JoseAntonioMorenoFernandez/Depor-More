            ...
            <div class="card-body d-flex flex-column">
                ...
                <h5 class="card-text mt-2 mb-2 fw-bold">Categoría: <?php echo $articulo['categoria']; ?></h4>
                    ...
                    <div class="row">
                        <div class="col-3 mt-5">
                            ...
                            <ul class="list-inline">
                                ...
                                ?>
                                        <select name="talla" class="form-select form-select-lg">
                                            <?php foreach ($enumList as $talla) { ?>
                    ...
                    <div class="col-1 mb-5 fs-4 mt-5">
                        ...
                        <input type="number" class="form-control fs-4" id="cantidad" name="cantidad" placeholder="0" value="<?php echo $can['cantidad']; ?>" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <?php if ($articulo['descuento']) : ?>
                                <h6 class="card-text fs-1 text-danger fw-bold text-decoration-none" name="descuento">Descuento - <?php echo  $articulo['descuento']; ?> %</h6>
                            <?php endif; ?>
                        </div>
                        <div class="col-2 text-end pe-5 pb-2">
                        
                            <input type="hidden" name="art_id" value="<?php echo $articulo['id_art']; ?>">
                            <input type="hidden" name="ean" value="<?php echo $articulo['ean']; ?>">
