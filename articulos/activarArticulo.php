...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nom_cat'], $_POST['nom_sub'])) {
    // Recupera los datos del formulario y guárdalos en sesiones
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="bg-light p-3 rounded">
                <form action="./articulos/activar_articulo.php" method="post" enctype="multipart/form-data">
                    <div class="bg-primary text-white p-2 mb-2 text-center">
                        <h3>Activar Artículo</h3>
                    </div>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary">Activar Artículo</button>
