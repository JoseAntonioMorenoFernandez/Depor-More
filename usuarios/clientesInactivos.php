    ...
    <div class="row justify-content-center">
        ...
        <?php
            ...
            <div class="bg-danger text-white p-2 mb-2 text-center">
                <h3>Administrar Clientes Inactivos</h3>
            </div>
            <div class="bg-light p-3 rounded">
                <table class="table table-striped table-striped-custom">
                    ...
                    <tbody>
                        ...
                        include 'clientes_inactivos.php';
                        ...
                        for ($i = $indice_inicio; $i < $indice_fin; $i++) {
                            ...
                            echo '<td>';
                            echo '<form action="index.php?page=activarCliente" method="POST">';
                                    ...
                                    <ul class="pagination justify-content-center">
                                        <?php for ($pagina = 1; $pagina <= $total_paginas; $pagina++) : ?>
                                            <li class="page-item <?php echo ($pagina == $pagina_actual) ? 'active' : ''; ?>">
                                                <a class="page-link" href="index.php?page=clientesInactivos&pagina=<?php echo $pagina; ?>"><?php echo $pagina; ?></a>
                                            </li>
                                        <?php endfor; ?>
                                    </ul>
                                </nav>
