...
<form action="index.php?page=administradoresInactivos" method="POST">
    <div class="row mb-3">
        <div class="col-md-3">
    ...
    <div class="row justify-content-center">
        ...
        <?php
            ...
            <div class="bg-danger text-white p-2 mb-2 text-center">
                <h3>Administrar Administradores Inactivos</h3>
            </div>
            <div class="bg-light p-3 rounded">
                <table class="table table-striped table-striped-custom">
                    ...
                    <tbody>
                        ...
                        include 'administradores_inactivos.php';
                        ...
                        for ($i = $indice_inicio; $i < $indice_fin; $i++) {
                            ...
                            echo '<td>';
                            echo '<form action="index.php?page=activarAdministrador" method="POST">';
                                    ...
                                    <ul class="pagination justify-content-center">
                                        <?php for ($pagina = 1; $pagina <= $total_paginas; $pagina++) : ?>
                                            <li class="page-item <?php echo ($pagina == $pagina_actual) ? 'active' : ''; ?>">
                                                <a class="page-link" href="index.php?page=empleadosInactivos&pagina=<?php echo $pagina; ?>"><?php echo $pagina; ?></a>
                                            </li>
                                        <?php endfor; ?>
                                    </ul>
                                </nav>
