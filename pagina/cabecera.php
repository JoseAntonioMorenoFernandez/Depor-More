...
<div class="container-fluid">
    <div class="cabecera">
        <div class="row align-items-center bg-dark text-light p-3">
            <div class="col-lg-4 col-md-12 mb-3 mb-lg-0">
                <div class="d-flex align-items-center ms-lg-5">
                    <img src="./imagenes/logo/LOGO.png" alt="Logo" width="100" class="d-inline-block align-top me-3">
                    <h1 class="mb-0 custom-h1">Depor More</h1>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-12 d-flex justify-content-center mt-3 mt-lg-0">
                <div class="icono-header d-flex justify-content-lg-end">
                    <div class="col-sd-12 d-inline-block me-4">
    ...
    <div class="row">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand ms-4" href="index.php?page=inicio">Inicio</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link ms-4 active" aria-current="page" href="index.php?page=tienda">Tienda</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ms-4" href="index.php?page=somos">Quiénes somos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ms-4" href="index.php?page=contacto">Contacto</a>
                        </li>
                    </ul>
                </div>
            </div>
