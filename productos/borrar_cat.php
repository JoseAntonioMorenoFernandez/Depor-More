...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn) {
        ...
        $sql = "UPDATE categorias SET nom_cat = '$nom_cat', nom_sub = '$nom_sub', activo = 'N' WHERE cod_cat = '$cod_cat' AND cod_sub = '$cod_sub'";

        if ($conn->query($sql) === TRUE) {
            
            $_SESSION['categoria_borrada'] = 'Categoría borrada correctamente.';
            $_SESSION['subcategoria_borrada'] = 'Subcategoría borrada correctamente.';
